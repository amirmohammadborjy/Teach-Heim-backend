...
//Route::middleware('auth:sanctum')->post('/register',[\App\Http\Controllers\UsersController::class,'update']);
Route::post('/user/add', [\App\Http\Controllers\UsersController::class,'store']);
